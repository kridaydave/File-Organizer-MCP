...
import { z } from 'zod';
import type { ToolDefinition, ToolResponse, BasicFileInfo, ListResult } from '../types.js';
...
export async function handleListFiles(args: Record<string, unknown>): Promise<ToolResponse> {
    try {
