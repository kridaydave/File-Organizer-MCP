...
import { z } from 'zod';
import type { ToolDefinition, ToolResponse, LargestFilesResult, LargestFileInfo } from '../types.js';
...
export const FindLargestFilesInputSchema = z
    .object({
        ...
        include_subdirs: z.boolean().optional().default(false).describe('Include subdirectories in search'),
        top_n: z
            .number()
            .int()
            .positive()
