...
The lean-v5 shape was benchmarked against v3.5.0 — preview/organize 12–35× faster with the content-analysis stack removed, organizer no longer fails on large directories, path-validation cost unchanged. Numbers and method: `docs/benchmarks-v5-vs-v3.5.md`.
