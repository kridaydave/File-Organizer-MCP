...
describe('RenamingService Integration', () => {
    ...
    it('should handle complex chaining of rules', async () => {
        ...
        const rules: RenameRule[] = [
            { type: 'find_replace', find: 'Draft - ', replace: '', global: false, use_regex: false, case_sensitive: true },
            { type: 'find_replace', find: ' ', replace: '_', global: true, use_regex: false, case_sensitive: false },
    ...
    it('should fail gracefully on disk conflict', async () => {
        ...
        const rules: RenameRule[] = [{
            type: 'find_replace', find: 'a', replace: 'b', global: false, use_regex: false, case_sensitive: false
        }];
    ...
    it('should support rollback', async () => {
        ...
        const rules: RenameRule[] = [{
            type: 'add_text', text: '_renamed', position: 'end'
        }];
