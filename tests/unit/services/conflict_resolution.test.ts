...
describe('Conflict Resolution Strategies', () => {
    ...
    it('should skip on conflict', async () => {
        ...
        const result = await organizer.organize(testDir, [srcFile], { conflictStrategy: 'skip' });
    ...
    it('should overwrite on conflict', async () => {
        ...
        const result = await organizer.organize(testDir, [srcFile], { conflictStrategy: 'overwrite' });
